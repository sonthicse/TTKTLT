...
public:
	...
	const std::vector<Book> &getList() const;
	...
	std::vector<int> searchExactLinear(SortCriteria key, const std::string &q);
	std::vector<int> searchExactBinary(SortCriteria key, const std::string &q);
	std::vector<int> searchContainsLinear(SortCriteria key, const std::string &q);
	std::vector<int> searchGlobalLinear(const std::string &q);
};
